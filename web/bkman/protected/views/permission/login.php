<div class="layout bg_login">
	<div id="login">
		...
		<ul>
			<li><label>手机号：</label><input type="text" id="mobile" name="mobile" class="txt" /></li>
			...
			<li style="color:#666">请妥善保管手机号和密码。<br>如遇到问题，请及时联系管理员。</li>
		</ul>
		<div style="color:#666"><a href="<?php echo WEB_QW_APP_DOMAIN ?>" target="_blank">玩主 - 就是玩得来</a></div>
	</div>
</div>
...
$(function(){
  var EventAction = {
  	message:{
    	"login_error": "请检查手机号或密码",//1001
    	"login_miss_param": "手机号或密码错误",//1002
  	...
  	login:function(_this){
  		if(EventAction.validateLogin()){
  			...
  			$.DeAjax(_this.id,{
  				...
  				data:{'mobile':mobile, 'passwd':passwd, '_sh_token_':_sh_token_},
