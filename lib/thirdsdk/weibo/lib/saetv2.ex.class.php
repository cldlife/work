...
class SaeTOAuthV2 {
	 ...
	 * @ignore
	 */
    function authorizeURL ($display = 'default') {
      return $display == 'mobile' ? 'https://open.weibo.cn/oauth2/authorize' : 'https://api.weibo.com/oauth2/authorize';
    }
	 ...
	 * @return array
	 */
	function getAuthorizeURL( $url, $state = NULL, $display = 'default', $response_type = 'code' ) {
		$params = array();
