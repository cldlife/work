...
class User {
  ...
  public function getToken ($userId, $name, $portraitUri) {
    try {
      ...
      if (empty($name)) throw new Exception('Paramer "name" is required');
      if (empty($portraitUri)) throw new Exception('Paramer "portraitUri" is required');
  ...
  public function addBlacklist ($userId, $blackUserId) {
    try {
      if (empty($userId)) throw new Exception('Paramer "userId" is required');
      if (empty($blackUserId)) throw new Exception('Paramer "blackUserId" is required');
