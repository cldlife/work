...
class Group {
  ...
  public function create ($userId, $groupId, $groupName) {
    try {
      ...
      if (empty($groupId)) throw new Exception('Paramer "groupId" is required');
      
      if (empty($groupName)) throw new Exception('Paramer "groupName" is required');
  ...
  public function sync ($userId, $groupInfo) {
    try {
      ...
      if (empty($groupInfo)) throw new Exception('Paramer "groupInfo" is required');
